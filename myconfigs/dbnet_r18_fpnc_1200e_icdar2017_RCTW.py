...
data_root = '/disk_sda/wgh/dataset/ocr/OCR_dataset_test/'
train = dict(
    type='IcdarDataset',
    ann_file=data_root + 'instances.json',
...
train_pipeline_r50dcnv2 = [
    ...
    dict(type='ColorJitter', brightness=0.12549019607843137, saturation=0.5),
    dict(
        type='Normalize', **img_norm_cfg_r50dcnv2),
    dict(
        type='ImgAug',
        args=[['Fliplr', 0.5], {
            'cls': 'Affine',
...
data = dict(
    ...
    test=dict(
        ...
        datasets=test_list,
        pipeline=test_pipeline_1333_736))
work_dir = '/disk_sda/wgh/workplace/work_dirs/mmocr/dbnet_r18_fpnc_1200e_icdar2017_RCTW'
