...
def data_transfor(img_dir, gt_dir, out_path):
    with mmcv.Timer(print_tmpl='It takes {}s to convert icdar annotation'):
        ...
        image_infos = collect_annotations(
            files, 'icdar2017', nproc=4)
        convert_annotations(image_infos, out_path)
...
if __name__ == '__main__':
    src = '/disk_sda/wgh/dataset/ocr/OCR_dataset_test'
    data_transfor(src + '/imgs', src + '/annotations',
                  src + '/instances.json')
